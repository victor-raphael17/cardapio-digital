...
export type CustomRuleVisitorWithExit<RuleVisitorType extends RuleVisitor> = import("./types.js").CustomRuleVisitorWithExit<RuleVisitorType>;
export type CustomRuleTypeDefinitions = $typests.CustomRuleTypeDefinitions;
export type CustomRuleDefinitionType<LanguageSpecificOptions extends Omit<import("@eslint/core").RuleDefinitionTypeOptions, keyof CustomRuleTypeDefinitions>, Options extends Partial<CustomRuleTypeDefinitions>> = import("./types.js").CustomRuleDefinitionType<LanguageSpecificOptions, Options>;
...
import type * as $typests from "./types.js";
/**
